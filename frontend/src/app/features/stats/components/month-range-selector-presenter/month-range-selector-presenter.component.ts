...
export const FIRST_MONTH_OF_CURRENT_YEAR = moment().startOf('year').format('YYYY-MM');
export const LAST_MONTH_OF_CURRENT_YEAR = moment().endOf('year').format('YYYY-MM');
...
export class MonthRangeSelectorPresenterComponent {
	...
	// todo refactor later to make it CLEAN and DRY
	setStartMonth(
